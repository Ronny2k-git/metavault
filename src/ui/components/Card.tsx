...
export const cardStyle = cva('w-full flex flex-col h-auto', {
  variants: {
    variant: {
      ...
      basic2:
        'bg-[linear-gradient(180deg,#0b030d,#1d0947)] shadow-[0_0_10px_0px_rgba(109,40,217,0.7)] border border-[#4c1d95]',
      ...
      tertiary: 'bg-black/25 hover:bg-black/35 border border-[#5b21b6]',
