...
const buttonStyle = cva('w-full flex items-center justify-center cursor-pointer', {
  variants: {
    ...
    variant: {
      primary: 'bg-gradient-to-t from-purple-950 to-violet-900 hover:to-violet-950 border border-purple-700/50',
      ...
      gradient: 'bg-gradient-to-r from-purple-900 to-violet-800 hover:to-violet-900 shadow-2xs shadow-indigo-300',
